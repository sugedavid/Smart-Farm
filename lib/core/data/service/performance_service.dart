...
class PerformanceService {
  ...
  // GPT
  final Trace gptChatbotTrace =
      FirebasePerformance.instance.newTrace("gpt-chatbot-trace");
  final Trace gptAnalysisTrace =
      FirebasePerformance.instance.newTrace("gpt-analysis-trace");
}
